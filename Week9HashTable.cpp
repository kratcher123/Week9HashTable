...
int main(int argc, char* argv[]) {
    ...
    cout << "TestGetSortedAssignmentNames(): " << (result3 ? "PASS" : "FAIL") << endl;
...
bool TestGetAssignmentScores() {
    ...
    unordered_map<int, double> hw2Scores = {
       pair<int, double>(11111, 89.0),
       pair<int, double>(22222, 75.0),
       pair<int, double>(33333, 100.0),
       pair<int, double>(44444, 50.0),
       pair<int, double>(55555, 76.5),
       pair<int, double>(66666, 84.5),
       pair<int, double>(77777, 76.0),
       pair<int, double>(88888, 74.5),
       pair<int, double>(99999, 100.0),
       pair<int, double>(10000, 90.0),
       pair<int, double>(90000, 85.0)
    };
    unordered_map<int, double> midtermScores = {
       pair<int, double>(11111, 91.0),
       pair<int, double>(22222, 77.5),
       pair<int, double>(33333, 88.0),
       pair<int, double>(44444, 40.0),
       pair<int, double>(55555, 64.5),
       pair<int, double>(66666, 91.0),
       pair<int, double>(77777, 75.0),
       pair<int, double>(88888, 88.0),
       pair<int, double>(99999, 88.0),
       pair<int, double>(10000, 92.0),
       pair<int, double>(90000, 90.0)
    };
    unordered_map<int, double> projectScores = {
       pair<int, double>(11111, 100.0),
       pair<int, double>(22222, 60.0),
       pair<int, double>(33333, 90.0),
       //pair<int, double>(44444, 80.0), // no entry for student 44444
       pair<int, double>(55555, 87.0),
       pair<int, double>(66666, 0.0),
       pair<int, double>(77777, 72.0),
       pair<int, double>(88888, 85.5),
       pair<int, double>(99999, 80.0),
       pair<int, double>(10000, 77.5),
       pair<int, double>(90000, 85.0)
    };

    // Each test case is a (assignmentName, mapOfExpectedScores) pair
    vector<pair<string, unordered_map<int, double>*>> testCases = {
       make_pair("Homework 2", &hw2Scores),
       make_pair("Midterm", &midtermScores),
    ...
    for (auto& testCase : testCases) {
        ...
        for (auto expectedPair : expectedMap) {
            ...
            bool areEqual = isnan(expectedScore) ?
                isnan(actualScore) : (actualScore == expectedScore);
            if (!areEqual) {
                cout << "FAIL: GetAssignmentScores(\"" << assignmentName;
